        ...
        <div className="p-4 rounded-md shadow-lg bg-blue-200">
          ...
          <div className="text-center mt-2">
            <p className="text-gray-600">
              <strong>Email:</strong> rudrasarkar@gmail.com
            </p>
            <p className="text-gray-600">
              <strong>Location:</strong> Kolkata
            </p>
            <p className="text-gray-600">
              <strong>Products No:</strong> 5
            </p>
            <div className="flex justify-center items-center gap-5">
              <button className="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-900 transition">
                Delete
              </button>
